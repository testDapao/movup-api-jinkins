...
import jp.co.vermore.entity.Category;
...
public class AdminNewsCategoryController extends BaseController {
    ...
    @RequestMapping(value = "/admin/news/listcategory/", method = RequestMethod.GET)
...
//        logger.info("----form{}-----",form);
        List<Category> list = newsService.getCategory();
        logger.info("-------list------{}",list);
        model.addAttribute("categorty_list", list);
        return "admin/newsListcategory";
    }

//    @RequestMapping(value = "/admin/news/listcategory/", method = RequestMethod.POST)
//    @ResponseBody
...
//    }
    ...
    @RequestMapping(value = "/admin/news/listcategory/",method = RequestMethod.POST)
    @ResponseBody
    public DatatablesJsonObject listcategory(@RequestBody NewsListForm form){
        List<Category> list = newsService.getCategory();
        logger.info("-------list------{}",list);
        DatatablesJsonObject datatablesJsonObject = new DatatablesJsonObject();
        datatablesJsonObject.setData(list);
        datatablesJsonObject.setDraw(form.getDraw());
        datatablesJsonObject.setRecordsFiltered(50);
        datatablesJsonObject.setRecordsTotal(50);
        logger.info("----------{}",datatablesJsonObject);
        return datatablesJsonObject;
    }
