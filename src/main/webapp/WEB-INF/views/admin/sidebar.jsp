...
<%--                            <li><a href="${pageContext.request.contextPath}/admin/news/listcategory/">ニュースカテゴリ</a></li>--%>
                            <li><a href="${pageContext.request.contextPath}/admin/event20/list/">ニュースカテゴリ</a></li>
                        <%--20210317楊追加--%>
