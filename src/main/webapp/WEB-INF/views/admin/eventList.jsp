                        ...
                        <div class="x_content">
                            ...
                            <form id="userForm" class="form-horizontal form-label-left input_mask" method="post">
                                ...
                                <div class=" col-sm-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-round btn-success"
                                       href="${pageContext.request.contextPath}/admin/event/regist/"
                            ...
                            <div class="table-responsive">
                                <table id="eventListTable" class="table table-striped jambo_table bulk_action">
                                    <thead>
                                    <tr class="headings">
                                        <th class="column-title" style="width: 30%;">タイトル</th>
                                        <th class="column-title" style="width: 10%;">開催日付</th>
                                        <th class="column-title" style="width: 30%;">抜粋</th>
                                        <th class="column-title" style="width: 10%;">TOP</th>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="confirmDeleteClick()">確定</button>
            </div>
...
<script>
    ...
    function gotoUpdate(id) {
        $('#eventLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/event/edit/' + id + '/';
    }
    ...
    function confirmDeleteClick() {
        ...
        $('#eventLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/event/delete/');
        form.attr('method', 'post');
        var input1 = $("<input type='hidden' name='event_id'/>");
