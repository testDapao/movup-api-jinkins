...
<%--&lt;%&ndash;                                <div class="col-md-11">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <label class="control-label col-md-1 col-sm-1 col-xs-12">掲載開始&gt=</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <div class="col-md-3 col-sm-3 col-xs-12 form-group">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <span class="fa fa-calendar form-control-feedback left" aria-hidden="true"></span>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <input type="date" class="form-control has-feedback-left" style="padding-right: 0;" id="publishStart">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <label class="control-label col-md-1 col-sm-1 col-xs-12">掲載終了&lt=</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <div class="col-md-3 col-sm-3 col-xs-12 form-group">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <span class="fa fa-calendar form-control-feedback left" aria-hidden="true"></span>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <input type="date" class="form-control has-feedback-left" style="padding-right: 0;" id="publishEnd">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                                <div class=" col-sm-1 col-sm-1 col-xs-12">--%>
<%--                                    <a class="btn btn-round btn-success"--%>
<%--                                       href="${pageContext.request.contextPath}/admin/event20/regist/"--%>
<%--                                       style="width: 100px; " onclick="gotoRegist()">--%>
<%--                                        <span class="glyphicon glyphicon-plus"ria-hidden="true"></span>新規</a>--%>
<%--                                </div>--%>
<%--                                <div class="col-md-11">--%>
...
<%--                                </div>--%>
<%--                            </form>--%>
<%--                            <form id="userForm2" class="form-horizontal form-label-left input_mask" method="GET">--%>
<%--                                &lt;%&ndash;                                <div class="col-md-11">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                    <label class="control-label col-md-1 col-sm-1 col-xs-12">掲載開始&gt=</label>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                    <div class="col-md-3 col-sm-3 col-xs-12 form-group">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <span class="fa fa-calendar form-control-feedback left" aria-hidden="true"></span>&ndash;%&gt;--%>
...
<%--                                    <div class="col-md-3 col-sm-1 col-xs-12 form-group has-feedback">--%>
<%--                                        <span class="fa fa-fire form-control-feedback left" aria-hidden="true"></span>--%>
<%--                                        <input type="text" class="form-control has-feedback-left" id="title2">--%>
<%--                                    </div>--%>

<%--                                    <label class="control-label col-md-1 col-sm-1 col-xs-12">TOP表示</label>--%>
<%--                                    <div class="col-md-3 col-sm-1 col-xs-12 form-group has-feedback">--%>
<%--                                        <span class="fa fa-fire form-control-feedback left" aria-hidden="true"></span>--%>
<%--                                        <input type="text" class="form-control has-feedback-left" id="sortScore2"--%>
<%--                                               data-rule-digits="true" data-rule-maxlength="4">--%>
<%--                                    </div>--%>
<%--                                </div>--%>
<%--                                <div class="col-md-1 text-right" style="padding-right: 15px">--%>
...
<%--                                    </div>--%>
                                    ...
                                    <div class=" col-sm-1 col-sm-1 col-xs-12" style="float: right;">
                                        <a class="btn btn-round btn-info " style="width: 100px;" onclick="searchDataByClo()"><span
                            ...
                            <div class="table-responsive">
                                <table id="eventListTable" class="table table-striped jambo_table bulk_action">
                                    <thead>
                                    <tr class="headings">
                                        <th class="column-title" style="width: 15%;">カテゴリ</th>
                                        <th class="column-title" style="width: 20%;">ニュース数</th>
                                        <th class="column-title" style="width: 65%;">最新ニュース</th>
<%--                                        <th class="column-title" style="width: 10%;">詳細</th>--%>
...
<div class="modal fade delete-event-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">削除</h4>
            </div>
            <div class="modal-body">
                <h5>データ削除は宜しいでしょうか？</h5>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">NO</button>
                <button type="button" class="btn btn-primary" onclick="confirmDeleteClick()">YES</button>
            </div>
...
<script>
    ...
    var datatable = $('#eventListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
            url: '/admin/event20/list/',
            type: 'POST',
            data: function (data) {
        ...
        columns: [
            ...
            //         return '<div>' + formatDate(full.holdDate) + '</div>';
            //     },
            //     name: "hold_date"
            // },
            ...
            { data: null,
                render: function (data, type, full, meta) {
                    if(full.categoryType==1){
                        return '<button type="button" class="btn btn-primary" style="width: 80px;">EVENT</button>';
                    }
                    if(full.categoryType==2){
                        return '<button type="button" class="btn btn-danger" style="width: 80px;">MOVEUP</button>';
                    }
                    if(full.categoryType==3){
                        return '<button type="button" class="btn btn-success" style="width: 80px;">NEWS</button>';
                    }
                    if(full.categoryType==4){
                        // return '<button type="button" class="btn btn-warning" style="width: 80px;"" ></button>';
                        return '<button type="button" class="btn btn-warning" style="width: 80px;">NEWTYPE</button>';
                    }if(full.categoryType>4){
                        // return '<button type="button" class="btn btn-warning" style="width: 80px;"" ></button>';
                        return '<button type="button" class="btn btn-round" style="width: 80px;">NEWTYPE</button>';
                    }
                    return "";
                }, name: "categoryType" },
            { data: "nums", name: "nums" },
            { data: "newsTitle", name: "title" },
            // {
            //     data: null,
            //     orderable: false,
            //     render: function (data, type, full, meta) {
            ...
            //         }
            //         if(full.entryType==1){
            //             return '<a class="btn btn-primary buttonDisabled" style="font-size: inherit; opacity: .65;" href="javascript:void(0)" onclick="('+full.id+')">応募</a>';
            //         }
            //         return '<a class="btn btn-primary" style="font-size: inherit;" href="javascript:void(0)" onclick="gotoRegistEntryMail('+full.id+')">応募</a>';
            //     },
            // },// 応募ボタン
            {
                data: null,
                orderable: false,
                render: function (data, type, full, meta) {
                    return '<a class="btn btn-primary" style="font-size: inherit;" href="javascript:void(0)" onclick="gotoUpdate('+full.categoryType+')">詳細</a>';
                }
            },// 詳細ボタン
            {
                data: null,
                orderable: false,
                render: function (data, type, full, meta) {
                    return '<button class="btn btn-danger" style="font-size: inherit;" onclick="gotoDelete('+full.categoryType+')">削除</button>';
                }
            }  //  削除ボタン
        ],
        columnDefs: [
    ...
    var currDeleteEventId = 0;

    function searchData() {
        //datatable.ajax.reload();
        window.location.href = 'http://localhost:8080/admin/event20/detail/';

    }
    function searchDataByClo() {
        datatable.ajax.reload();
        //window.location.href = 'http://localhost:8080/admin/event20/searchByclo/';

    }

    function gotoDelete(id) {
        currDeleteEventId = id;
        $('.delete-event-modal').modal("show");
    }

    function gotoUpdate(id) {
        $('#eventLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/event20/news/' + id + '/';
    }

    function gotoRegist(id) {
        $('#eventLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/event/regist/' + id + '/';
    }
    ...
    function confirmDeleteClick() {
        ...
        $('#eventLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/event20/delete/');
        form.attr('method', 'post');
        var input1 = $("<input type='hidden' name='categoryType'/>");
        input1.attr('value', currDeleteEventId);
        form.append(input1);
        form.appendTo("body");
