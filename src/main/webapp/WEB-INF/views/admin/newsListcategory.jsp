                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="table-responsive">
                                    <table id="newsCategory" class="table table-striped jambo_table bulk_action">
                                        <thead>
                                        <tr class="headings">
                                            <th class="column-title" style="width: 25%;">カテゴリ名</th>
                                            <th class="column-title" style="width: 25%;">数量</th>
                                            <th class="column-title" style="width: 40%;">最新ニュース</th>
...
<script>
    ...
    var datatable = $('#newsCategory').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
            url: '/admin/news/listcategory/',
            type: 'POST',
            data: function (data) {
